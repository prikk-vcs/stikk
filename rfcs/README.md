...
| 029 | [The prikk 0.42 re-baseline, and prikk's current branch](./accepted/029-prikk-0-42-rebaseline-and-the-current-branch.md) | ceiling 41 → 42 (stikk's suite already passes at 0.28 and 0.42); prikk's new current branch against stikk's client-side focused ref. **Accepted 2026-09-13; Q1 open** | [A: re-baseline](./handoffs/029-prikk-0-42-rebaseline-and-the-current-branch/a-rebaseline-handoff-v1.md) · B: waits for Q1 |
