...
|----|-------|-----------|---------|
| 021 | [The prikk 0.38 re-baseline: `UD-09` retires, and a fabricated worktree entry](./accepted/021-prikk-0-38-rebaseline.md) | **Five** prikk releases at once. `prikk show` retires the content dependency carried since 0.1.0; `Ready` becomes constructible; the Queue view unblocks. **F0: on prikk ≥ 0.38 stikk fabricates a Changes entry** — wrong in shipped 0.4.1, fixed first and alone. **Accepted 2026-09-12** | [A: F0](./handoffs/021-prikk-0-38-rebaseline/f0-worktree-entry-scoping-handoff-v1.md) · B: pending |
